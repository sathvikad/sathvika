<?php
   ...
   $sql = "INSERT INTO money_transfer (id,receiver_name, sender_name,email,amount) VALUES ('$id','$receiver_name', '$sender_name','$email','$amount')";
...
<html>
 ...
 <?php include 'home.php' ; ?>
    ...
    <section class="container black-text">
        ...
        <form class="white" action="transfermoney.php" method="POST">
            <label>ID</label>
